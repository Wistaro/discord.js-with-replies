...
export class BroadcastDispatcher extends VolumeMixin(StreamDispatcher) {
...
export class StreamDispatcher extends VolumeMixin(Writable) {
...
export class OverridableManager<V, K, R = any> extends BaseManager<V, K, R> {
...
declare function PartialTextBasedChannel<T>(Base?: Constructable<T>): Constructable<T & PartialTextBasedChannelFields>;
declare function TextBasedChannel<T, I extends keyof TextBasedChannelFields = never>(
...
declare function WebhookMixin<T>(Base?: Constructable<T>): Constructable<T & WebhookFields>;

declare function VolumeMixin<T>(base: Constructable<T>): Constructable<T & VolumeInterface>;
